...
<section class="relative flex min-h-[calc(100vh-4rem)] w-full items-center overflow-hidden">
	...
	<div class="relative z-10 mx-auto w-full max-w-5xl px-6">
		<p class="fade-up text-sm text-c-light-blue/80" style="--i: 0">Full-stack developer · Manila</p>

		<h1
			class="fade-up mt-4 text-5xl font-bold tracking-tight text-balance text-c-white sm:text-6xl lg:text-7xl"
			style="--i: 1"
		>
			Michael Real
		</h1>

		<p class="fade-up mt-4 text-lg text-balance text-c-white/70" style="--i: 2">
